...
curl -fSsL -O https://github.com/NVIDIA/enroot/releases/download/v4.2.0/enroot_4.2.0-1_${arch}.deb
curl -fSsL -O https://github.com/NVIDIA/enroot/releases/download/v4.2.0/enroot+caps_4.2.0-1_${arch}.deb # optional
sudo apt install -y ./*.deb

# RHEL-based distributions
arch=$(uname -m)
sudo dnf install -y epel-release # required on some distributions
sudo dnf install -y https://github.com/NVIDIA/enroot/releases/download/v4.2.0/enroot-4.2.0-1.el8.${arch}.rpm
sudo dnf install -y https://github.com/NVIDIA/enroot/releases/download/v4.2.0/enroot+caps-4.2.0-1.el8.${arch}.rpm # optional
```
...
# Debian-based distributions
arch=$(dpkg --print-architecture)
curl -fSsL -O https://github.com/NVIDIA/enroot/releases/download/v4.2.0/enroot-hardened_4.2.0-1_${arch}.deb
curl -fSsL -O https://github.com/NVIDIA/enroot/releases/download/v4.2.0/enroot-hardened+caps_4.2.0-1_${arch}.deb # optional
sudo apt install -y ./*.deb

# RHEL-based distributions
arch=$(uname -m)
sudo dnf install -y epel-release # required on some distributions
sudo dnf install -y https://github.com/NVIDIA/enroot/releases/download/v4.2.0/enroot-hardened-4.2.0-1.el8.${arch}.rpm
sudo dnf install -y https://github.com/NVIDIA/enroot/releases/download/v4.2.0/enroot-hardened+caps-4.2.0-1.el8.${arch}.rpm # optional
```
