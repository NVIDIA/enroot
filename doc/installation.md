...
curl -fSsL -O https://github.com/NVIDIA/enroot/releases/download/v4.1.2/enroot_4.1.2-1_${arch}.deb
curl -fSsL -O https://github.com/NVIDIA/enroot/releases/download/v4.1.2/enroot+caps_4.1.2-1_${arch}.deb # optional
sudo apt install -y ./*.deb

# RHEL-based distributions
arch=$(uname -m)
sudo dnf install -y epel-release # required on some distributions
sudo dnf install -y https://github.com/NVIDIA/enroot/releases/download/v4.1.2/enroot-4.1.2-1.el8.${arch}.rpm
sudo dnf install -y https://github.com/NVIDIA/enroot/releases/download/v4.1.2/enroot+caps-4.1.2-1.el8.${arch}.rpm # optional
```
...
# Debian-based distributions
arch=$(dpkg --print-architecture)
curl -fSsL -O https://github.com/NVIDIA/enroot/releases/download/v4.1.2/enroot-hardened_4.1.2-1_${arch}.deb
curl -fSsL -O https://github.com/NVIDIA/enroot/releases/download/v4.1.2/enroot-hardened+caps_4.1.2-1_${arch}.deb # optional
sudo apt install -y ./*.deb

# RHEL-based distributions
arch=$(uname -m)
sudo dnf install -y epel-release # required on some distributions
sudo dnf install -y https://github.com/NVIDIA/enroot/releases/download/v4.1.2/enroot-hardened-4.1.2-1.el8.${arch}.rpm
sudo dnf install -y https://github.com/NVIDIA/enroot/releases/download/v4.1.2/enroot-hardened+caps-4.1.2-1.el8.${arch}.rpm # optional
```
