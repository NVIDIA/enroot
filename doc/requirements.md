...
```sh
$ curl -fSsL -O https://github.com/NVIDIA/enroot/releases/download/v1.0.0/enroot-check_1.0.0.run
$ chmod +x enroot-check_1.0.0.run

$ ./enroot-check_1.0.0.run --verify

$ ./enroot-check_1.0.0.run
